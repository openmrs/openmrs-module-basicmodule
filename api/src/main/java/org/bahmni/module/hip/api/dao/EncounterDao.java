...
public interface EncounterDao {
    ...
    List<Integer> GetEncounterIdsForVisitForPrescriptions(String patientUUID, String visit, Date visitStartDate) ;
    ...
    List<Integer> GetEncounterIdsForVisitForDiagnosticReport(String patientUUID, String visit,Date visitStartDate) ;
}
